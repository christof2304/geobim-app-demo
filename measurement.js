...
(function(BimViewer) {
  ...
  BimViewer.startDistanceMeasurement = function() {
    ...
    this.updateMeasurementResult('<span style="color: #667eea;">📏 Click first point...</span>');
    ...
    handler.setInputAction((click) => {
      ...
      if (this.measurement.positions.length === 1) {
        this.updateMeasurementResult('<span style="color: #667eea;">📏 Click second point...</span>');
